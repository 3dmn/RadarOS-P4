...
- **Nowoczesny panel WWW z zakładkami** — inspirowany Awtrix 3, responsywny ciemny motyw neon green (Radar i wyświetlacz · Lokalizacja · Sieć Wi-Fi · System), który automatycznie przełącza domyślną zakładkę na Wi-Fi, gdy urządzenie serwuje własny punkt dostępowy konfiguracyjny.
